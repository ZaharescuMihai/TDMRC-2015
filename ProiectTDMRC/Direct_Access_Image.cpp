...
//===========================================================================
//===========================================================================
void KImage::SaveAs(const char*strFileName, unsigned intFormatType)
{
...
int KImage::ExportAs_JP2K(
    ...
    std::map <double, double&> *pQualityLayers, 
    std::map <CRect, const CRect& > *pInterestArea
    )
{
    SaveAs(strFileName, SAVE_JPEG_QUALITYSUPERB);
    return 10;
}*/
//===========================================================================
//===========================================================================
